    ...
    return (
        <>
            <header className="bg-white">
                <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between py-6">
                    ...
                    <PopoverGroup className="hidden lg:flex lg:gap-x-12 rounded-3xl ring-1 ring-inset ring-gray-300 pl-8 pr-3 py-2 items-center">
                        ...
                        <div className="text-white ring-1 ring-inset ring-gray-300 rounded-full p-1.5 cursor-pointer bg-primary">
